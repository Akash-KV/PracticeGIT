# Dna_ItembankAssessment_Rostering
Version: 2.0 <br />
ID: A-5 <br />
...
```jshelllanguage
.
├── Dna_ItembankAssessment_Rostering.iml
├── README.md
├── _classpath.xml
├── _project.xml
├── jmeter.log
...
│       │        │
│       │        ├── Config.java
│       │        ├── CreateNewItembankAssessmentTest.java
│       │        ├── DataReader.java
│       │        └── Helper.java
│       └── resources
│           └── org
│               └── graphwalker
│                   ├── CreateNewItembankAssessment.graphml
│                   └── data.csv
│
└── target
    ├── classes
	...
	│        │        
    │        ├── Config.class
    │        ├── CreateNewItembankAssessmentTest.class
    │        ├── CreateNewItembankAssessment.graphml
    │        ├── CreateNewItembankAssessmentTest.class
    │        └── Helper.class
	│
