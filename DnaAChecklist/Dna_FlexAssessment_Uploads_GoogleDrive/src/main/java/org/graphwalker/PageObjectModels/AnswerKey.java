...
//Page object model class for Answer Key
public class AnswerKey {
    private String answerKeyAddQuestions, answerKeyQuestionQuantity, answerKeyAddButton, answerKeyUploads;
    private String explicitConstructedResponseAddIcon, explicitConstructedResponseFirstInput, explicitConstructedResponseSecondInput;
    private String multipleChoiceAdvanced;
    private String answerKeyMaterial, answerKeyResources;
    String dir = null;
