...
public class FlexAnswerKeyPage {
    ...
    private String flexAnswerKeyAdministerButton, flexAnswerKeyOnlineTesting, flexAnswerKeyPdfConfirmation, flexAnswerKeyPdfConfirmationModel, flexAnswerKeyResourcesUploader;
    private String flexAnswerKeyTestGoogleDoc, flexAnswerKeyCloseButton;
    ...
    public FlexAnswerKeyPage() {
        try {
            ...
            dir = dir.replace("Dna_FlexAssessment_Uploads_GoogleDrive", "");
    ...
    */
    ...
    public String getFlexAnswerKeyResourcesUploader() {
        flexAnswerKeyResourcesUploader = properties.getProperty("FLEXANSWERKEY_PDFCONFIRMATIONMODEL");
        return flexAnswerKeyResourcesUploader;
    }
