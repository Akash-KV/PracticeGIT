...
public class CreateFlexAssessmentAllTestCasesTest extends ExecutionContext implements CreateFlexAssessmentAllTestCases {
    ...
    public void v_AnswerKeyPage() {
        ...
        // pdf
        FlexAssessmentController.Uploads.uploadGoogleDrive("test_google_doc", waiter, driver);
        FlexAssessmentController.Uploads.checkPreviewModal("test_google_doc", waiter, driver);
