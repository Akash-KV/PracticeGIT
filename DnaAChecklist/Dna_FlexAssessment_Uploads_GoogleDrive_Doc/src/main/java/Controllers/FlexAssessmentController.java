...
public class FlexAssessmentController {
    ...
    public static class Uploads {
        ...
        public static String uploadGoogleDriveLogin(WebDriverWait waiter, WebDriver driver) {
            ...
            Helper.wait(2.0);
            if (driver.findElements(By.xpath(flexAnswerKeyPage.getFlexAnswerKeyIlluminateUser())).size() != 0) {
                Actions actions = new Actions(driver);
                actions.moveToElement(driver.findElement(By.xpath(flexAnswerKeyPage.getFlexAnswerKeyIlluminateUser())));
                actions.click();
...
//                Helper.clickXpath(flexAnswerKeyPage.getFlexAnswerKeyPasswordNext(), waiter, driver);
        ...
        public static void checkPreviewModal(String upload, WebDriverWait waiter, WebDriver driver) {
            Helper.wait(5.0);
