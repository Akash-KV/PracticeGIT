...
public class AnswerKey {
    ...
    private String answerKeyMaterial, answerKeyResources, answerKeyUploads, explicitConstructedResponseFirstInput, explicitConstructedResponseAddIcon, explicitConstructedResponseSecondInput;
