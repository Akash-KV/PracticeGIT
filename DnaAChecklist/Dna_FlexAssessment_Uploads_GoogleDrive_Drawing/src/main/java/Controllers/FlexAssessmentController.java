...
public class FlexAssessmentController {
    ...
    public static class Uploads {
        ...
        public static String uploadGoogleDriveLogin(WebDriverWait waiter, WebDriver driver) {
            ...
            actions.moveToElement(driver.findElement(By.xpath(flexAnswerKeyPage.getFlexAnswerKeyPasswordNext()))).doubleClick().build().perform();//     Helper.clickXpath(flexAnswerKeyPage.getFlexAnswerKeyIdentifierNext(), waiter, driver);
//            Helper.sendKeysXpath(flexAnswerKeyPage.getFlexAnswerKeyPassword(), Config.getEmailPassword(), waiter, driver);
...
//                Helper.wait(5.0);
//                Helper.clickXpath("//button[contains(text(),'Material')]", waiter, driver);
//                Helper.wait(5.0);
//                WebElement icon = waiter.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"resources\"]/tbody/tr/td[3]/div/button[1]")));
//                Actions actions = new Actions(driver);
//                actions.moveToElement(icon);
//                actions.click();
//                actions.build().perform();
//                Helper.wait(5.0);
//            } while (driver.findElements(By.xpath("//div[@class='textLayer']")).size() == 0);
//            Helper.clickXpath("//button[contains(text(),'Close')]", waiter, driver);
//            Helper.clickXpath("//div[@class='container-fluid d-flex h-100 flex-column']//button[@type='button'][contains(text(),'×')]", waiter, driver);
            //do {
            //exitUploadMaterialsModal(waiter, driver);
...
//                }
        ...
        public static void checkPreviewOnlineTestingFromAdministrationPage(Boolean isPdf, WebDriverWait waiter, WebDriver driver) {
            ...
            if (isPdf == true) {
                Helper.wait(3.0);
                String pdfUrl = waiter.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//embed[@type='application/pdf']"))).getAttribute("src");
