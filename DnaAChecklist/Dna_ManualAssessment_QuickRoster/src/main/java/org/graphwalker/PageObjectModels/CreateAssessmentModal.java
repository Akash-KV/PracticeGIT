...
public class CreateAssessmentModal {
    ...
    private String modalManualNumberOfQuestions, clickLegayTab, createAssessmentModalCreateButton;
    private String okayButton, createAssessmentModalManual, createAssessmentModalNumberOfQuestions;
