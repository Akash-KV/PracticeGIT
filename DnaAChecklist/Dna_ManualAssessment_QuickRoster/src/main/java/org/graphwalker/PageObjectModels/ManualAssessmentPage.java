...
public class ManualAssessmentPage {
    private String stepOneTitle, stepThreeMultipleChoice, stepThreeMultipleChoiceAdvanced;
    private String nextButton, stepThreeConstructedResponse, stepNext;
    private String stepTwoSubjectArea, stepThreeConstructedResponseNextOne;
    private String stepTwoSubjectAreaDropdownOptionChosen;
    private String stepTwoSearch, manualAssessmentInfo;
