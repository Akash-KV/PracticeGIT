...
public class AssessmentPanelPage {
    ...
    private String page, Answer, FirstAnswer, SecondAnswer, ThirdAnswer, FourthAnswer, FifthAnswer, SixthAnswer, exit;
    ...
    */
    ...
    public String getAnswer() {
        Answer = properties.getProperty("ASSESSMENTPANEL_ANSWER");
        return Answer;
    }
