...
public class FlexAnswerKeyPage {
    ...
    private String flexAnswerKeyAdministerButton, flexAnswerKeyOnlineTesting, flexAnswerKeyPreviewIcon, googleDriveChangeFrame, pdfUploadName;
    private String flexAnswerKeyCloseButton, flexAnswerKeyIlluminateUser, flexAnswerKeyPdfConfirmation, closeButton, flexAnswerKeyPdfConfirmationModel, flexAnswerKeyTestGoogleDoc, flexAnswerKeyFlexColumnClose;
    ...
    public FlexAnswerKeyPage() {
        try {
            ...
            dir = dir.replace("Dna_FlexAssessment_Uploads_Local_Pdf", "");
    ...
    */
    ...
    public String getFlexAnswerKeyPreviewIcon() {
        flexAnswerKeyPreviewIcon = properties.getProperty("FLEXANSWERKEY_PREVIEWICON");
        return flexAnswerKeyPreviewIcon;
    }

    public String getGoogleDriveChangeFrame() {
        googleDriveChangeFrame = properties.getProperty("FLEXANSWERKEY_UPLOADGOOGLEDRIVE_CHANGEFRAME");
        return googleDriveChangeFrame;
    }

    public String getPdfUploadName() {
        pdfUploadName = properties.getProperty("FLEXANSWERKEY_UPLOAD_NAME");
        return pdfUploadName;
    }

    public String getCloseButton() {
        closeButton = properties.getProperty("FLEXANSWERKEY_CLOSEBUTTON");
        return closeButton;
    }
}
