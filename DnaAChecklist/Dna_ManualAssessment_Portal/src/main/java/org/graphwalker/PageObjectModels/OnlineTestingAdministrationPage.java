...
public class OnlineTestingAdministrationPage {
    private String testWithQuickCodeButton, onlineTestingAdministrationPreviewAssessment, onlineTestingAdministrationEditThirdAnswer, onlineTestingAdministrationviewType, onlineTestingAdministrationOverview, onlineTestingAdministrationThirdAnswerBox, onlineTestingAdministrationFirstAnswerBox, onlineTestingAdministrationassessmentPanel, onlineTestingAdministrationLiveProctoring, onlineTestingAdministrationFinishButton, onlineTestingAdministrationFirstAnswer, onlineTestingAdministrationSuccess;
    private String testWithQuickCodePostCreationModalExitButton, onlineTestingAdministrationOverviewAssessmentButton, onlineTestingAdministrationSaveEdited, onlineTestingAdministrationExit, onlineTestingAdministrationSecondAnswerBox, onlineTestingAdministrationSecondAnswer, onlineTestingAdministrationThirdAnswer;
