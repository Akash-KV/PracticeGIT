    ...
    public static class Uploads {
        ...
        public static void uploadGoogleDrive(String uploadName, WebDriverWait waiter, WebDriver driver) {
            ...
            try {
                ...
                //driver.switchTo().frame(driver.findElement(By.xpath("/html[1]/body[1]/div[7]/div[2]/iframe[1]")));

                //driver.switchTo().frame(driver.findElement(By.xpath("/html[1]/body[1]/div/div[2]/iframe[1]")));
        ...
        public static String uploadGoogleDriveLogin(WebDriverWait waiter, WebDriver driver) {
            ...
            //Helper.sendKeysXpath("//*[@id=\"identifierId\"]", "illuminatetestuser@gmail.com", waiter, driver);
        ...
        public static void uploadGoogleDrivePdfConversionConfirmation(String uploadName, WebDriverWait waiter, WebDriver driver) {
            ...
            try {
                Assert.assertEquals(uploadName, driver.findElement(By.xpath(flexAnswerKeyPage.getFlexAnswerKeyResourcesUploader())).getText());
            } catch (Exception e) {
