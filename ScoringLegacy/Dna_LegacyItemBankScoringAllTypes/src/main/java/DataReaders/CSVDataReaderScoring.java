...
public class CSVDataReaderScoring {
    ...
    private String highlightText, assessmentDescription, academicYear, grade, CorrectAnswer, IncorrectAnswer, NTSecondAnswerChoice, subject, type, subjectStep2, ItemName, gradeStep2;
    ...
    private String multiPortWrongAnswer, highlightSelectableText, highlightSelectableTextWrongAnswer, multiPortSecondAnswer;
    ...
    public Map<String, String> getCsv() {
        ...
        try {
            ...
            while (readercsv.readRecord()) {
                highlightText = readercsv.get("HighlightSelectableText");
                ...
                highlightSelectableText = readercsv.get("HighlightSelectableTextSecondAnswer");
                highlightSelectableTextWrongAnswer = readercsv.get("HighlightSelectableTextWrongAnswer");
                multiPortSecondAnswer = readercsv.get("MultiPartSecondAnswer");
                Maprecords.put("HighlightSelectableText", highlightText);
                ...
                Maprecords.put("HighlightSelectableTextSecondAnswer", highlightSelectableText);
                Maprecords.put("HighlightSelectableTextWrongAnswer", highlightSelectableTextWrongAnswer);
                Maprecords.put("MultiPartSecondAnswer", multiPortSecondAnswer);
    ...
    */
    ...
    public String getMultiPortSecondAnswer() {
        multiPortSecondAnswer = getCsv().get("MultiPartSecondAnswer").trim();
        return multiPortSecondAnswer;
    }
    ...
    public String getHighlightText() {
        highlightText = getCsv().get("HighlightSelectableText").trim();
        return highlightText;
    }

    public String getHighlightSelectableTextWrongAnswer() {
        highlightSelectableTextWrongAnswer = getCsv().get("HighlightSelectableTextWrongAnswer").trim();
        return highlightSelectableTextWrongAnswer;
    }

    public String getHighlightSelectableText() {
        highlightSelectableText = getCsv().get("HighlightSelectableTextSecondAnswer").trim();
        return highlightSelectableText;
    }
