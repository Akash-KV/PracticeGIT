...
//Java Class for ViewAssessmentsAssessmentsDropDownOptionsTest
@GraphWalker(value = "quick_random(edge_coverage(100))")
public class ViewAssessmentsAssessmentsDropDownOptionsTest extends ExecutionContext implements ViewAssessmentsAssessmentsDropDownOptions {
    ...
    boolean isAdminster, searchElementExist, viewResult, checkToggleTable = true;
...
//        Assert.assertTrue(DriverHelper.elementExistence(Element, BrowserInitHelper.getInstance()));
    ...
    public void e_ClickActionDropDown() {
        //Sending Bank Name to search bar
        BrowserInitHelper.getInstance().findElement(By.xpath(viewAssessmentsPage.getSearchText())).sendKeys(viewAssessmentsPage.getAssessmentTitle());
        ...
        DriverHelper.waitForPageLoadComplete();
        DriverHelper.clickXpath(viewAssessmentsPage.getAssessmentActionDropDown());
    }

    public void e_ClickActionDropDownAndSelectAdministerOption() {
        /*Click Administer option*/
        viewAssessmentsController.clickAssessmentsAdministerOption("Administer");
    ...
    public void e_ClickActionDropDownAndSelectPreviewOption() {
        ...
        viewAssessmentsController.clickAssessmentsPreviewOption("Preview");
    }
    ...
    public void e_ClickActionDropDownAndSelectScanOption() {
        DriverHelper.waitForPageLoadComplete();
        /*Click Scan option*/
        viewAssessmentsController.clickAssessmentsScanOption("Scan");
...
//        Assert.assertTrue(DriverHelper.elementExistence(Element, BrowserInitHelper.getInstance()));
    ...
    public void e_ClickActionDropDownAndSelectViewResultsOption() {
        if (checkToggleTable) {
            ...
            viewAssessmentsController.clickAssessmentsViewResultOption("View Results");
        }
    }
    ...
    public void e_ClickActionDropDownAndSelectViewShareOption() {
        ...
        //JavascriptHelper.ScrollTillElement_Javascript(viewAssessmentsPage.getAssessmentActionDropDown());

        /*Click Share option*/
        viewAssessmentsController.clickAssessmentsShareOption("Share");
    }
    ...
    public void e_ClickActionDropDownAndSelectDuplicateOption() {
        ...
        viewAssessmentsController.clickAssessmentsDuplicateOption("Duplicate");
    ...
    public void v_VerifyAssessmentTypeFlexibleDataTable() {
        DriverHelper.waitUntilLoaderInvisible();
        ConsoleLogger.SuccessLog("Complete the ViewAssessmentsAssessmentsDropDownOptionsTest Java class");
    }
}
