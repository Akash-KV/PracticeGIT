...
public class Dashboard {
    private String dashboardHeader, illuminateLogo, assessmentsIcon, viewAssessmentsLink, viewAssessmentsHeader, dashboardTile;
    String dir = null;
    ...
    public String getDashboardTile() {
        dashboardTile = properties.getProperty("DASHBOARD_TILE");
