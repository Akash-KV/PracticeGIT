...
//Page Object Model Class for ViewAssessments_AddFilters Page
public class ViewAssessments_AddFilters {
    ...
    private String scopeFilter, subjectFilter, dateCreated_Start, dateCreated_End, closeButton, addFilterModelPopup;
    ...
    public String getAddFilterModelPopup() {
        addFilterModelPopup = "list-assessment-filters-modal";
        return addFilterModelPopup;
    }
}
