...
public class JavascriptHelper {
    ...
    public static void clickID_JS(String ID) {
        ...
        ((JavascriptExecutor) BrowserInitHelper.getInstance()).executeScript("arguments[0].click();", BrowserInitHelper.getWaiter().until(ExpectedConditions.elementToBeClickable(By.id(ID))));
    }

    public static void clickID_JSJQuery(String ID) {
