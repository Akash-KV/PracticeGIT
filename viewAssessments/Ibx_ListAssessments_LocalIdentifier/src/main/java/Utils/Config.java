...
public class Config {
    ...
    private static String shared_username = null;
    private static String shared_password = null;
    ...
    public void readProperties() {
        try {
            ...
            shared_username = properties.getProperty("SHARED_USERNAME");
            shared_password = properties.getProperty("SHARED_PASSWORD");
            ...
            System.out.println("chrome Path==>" + chrome);
    ...
    /**
     * Methods to read from Config file
     **/
