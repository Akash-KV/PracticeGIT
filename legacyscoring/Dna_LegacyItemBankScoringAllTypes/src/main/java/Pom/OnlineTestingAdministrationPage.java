...
public class OnlineTestingAdministrationPage {
    ...
    private  String onlineTestingAdministrationConfirmFinish,onlineTestingAdministrationHighlightSelectableTextWrongAnswer,onlineTestingAdministrationHighlightSelectableTextSecondAnswer,onlineTestingAdministrationMultiPartSecondAnswer,onlineTestingAdministrationHighlightSelectableText,onlineTestingAdministrationDragAndDropFirstAnswer,onlineTestingAdministrationDragAndDropSecondAnswer,onlineTestingAdministrationDragAndDropThirdAnswer;
    String dir = null;
    ...
    */
    ...
    public String getOnlineTestingAdministrationMultiPartSecondAnswer()
    {
        onlineTestingAdministrationMultiPartSecondAnswer=properties.getProperty("ONLINETESTINGADMINISTRATION_MULTIPARTSECONDANSWER");
     return   onlineTestingAdministrationMultiPartSecondAnswer;
    }
    public String getOnlineTestingAdministrationHighlightSelectableTextSecondAnswer()
    {
        onlineTestingAdministrationHighlightSelectableTextSecondAnswer=properties.getProperty("ONLINETESTINGADMINISTRATION_HIGHLIGHTSELECTABLETEXTSECONDANSWER");
        return   onlineTestingAdministrationHighlightSelectableTextSecondAnswer;
    }
    public String getOnlineTestingAdministrationHighlightSelectableTextWrongAnswer()
    {
        onlineTestingAdministrationHighlightSelectableTextWrongAnswer=properties.getProperty("ONLINETESTINGADMINISTRATION_SELECTHIGHLIGHTWRONGANSWER");
        return   onlineTestingAdministrationHighlightSelectableTextWrongAnswer;
    }
