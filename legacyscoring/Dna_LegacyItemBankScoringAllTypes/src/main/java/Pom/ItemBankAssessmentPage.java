...
public class ItemBankAssessmentPage {
    String createNewAssessmentHeader, assessmentNameTextbox,itemBankAsssessmentSearch, createButton, addItemFlashButton, addQuestionsInput, addQuestionsOKButton, createItemRemoveChoice;
    ...
    */
    ...
    public String getItemBankAsssessmentSearch() {
      itemBankAsssessmentSearch = properties.getProperty("ITEMBANKASSESSMENT_SEARCH");
        return itemBankAsssessmentSearch;
    }
