...
public class BrowseModePage {
    ...
    private static String browse_CreateAssessmentButton, browse_Title_In_CreateAssessmentPopup, browse_CreateButton_In_CreateAssessmentPopup;
    private static String browse_ItemSection, browse_AddItem_List, filters, bankFilterFirstCheckbox, browseModeFirstItem;
