...
│       │   │   
│       │   └── DataReaders
│		│	│    └── CSVDataReaderBuildItemDescription.java
│       │   │
│       │   │       
│       │   └── Helpers
...
│       │   │    └── Static.java
│       │   │     
│       │   ├── BuildModeDescriptionTest.java
│       │   ├── LoginPageTest.java
│       │   └── UserSwitchModelTest.java
│       │
│       └── resources
│           ├── BuildModeAddDescription.csv
│           ├── BuildModeAddDescription.graphml
│           ├── LoginPage.graphml
...
└── target
    ...
    │   │     └── Static.class
	│   │
	│   ├── BuildModeAddDescription.class 
    │   ├── BuildModeAddDescription.csv
	│   ├── BuildModeAddDescription.graphml 
    │   ├── BuildModeDescriptionTest.class
    │   ├── LoginPage.class
	│	├── LoginPage.graphml
	│   ├── LoginPageTest.class
