...
public class BrowserInitHelper {
    ...
    public static void setup() {
        ...
        if (browser.equals("chrome")) {
            ...
            profile.setPreference("browser.helperApps.neverAsk.saveToDisk", "application/msword, application/vnd.openxmlformats-officedocument.presentationml.presentation, application/octet-stream,application/x-excel, application/x-msexcel, application/excel, application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/xls, text/csv, image/png, image/jpeg, image/svg+xml, application/pdf, application/zip, application/x-bzip, application/x-bzip2, application/epub+zip, application/x-7z-compressed");
            profile.setPreference("browser.helperApps.neverAsk.openFile", "application/pdf, application/xls, application/octet-stream, image/png, image/jpeg, image/svg+xml,application/zip, application/x-bzip, application/x-bzip2, application/epub+zip, application/x-7z-compressed");
