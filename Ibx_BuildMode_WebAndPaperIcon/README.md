...
```jshelllanguage
.
├── Ibx_BuildMode_WebAndPaperIcon.iml
├── README.md
├── _classpath.xml
├── _project.xml
├── jmeter.log
...
│       │   │    └── Static.java
│       │   │     
│       │   ├── BuildModeWebAndPaperIconTest.java
│       │   ├── LoginPageTest.java
│       │   └── UserSwitchModelTest.java
│       │
│       └── resources
│           ├── BuildModeWebAndPaper.csv
│           ├── BuildModeWebAndPaperIcon.graphml
│           ├── LoginPage.graphml
...
└── target
	...
	│   │
	│   ├── BuildModeWebAndPaper.csv 
    │   ├── BuildModeWebAndPaperIcon.class
	│   ├── BuildModeWebAndPaperIcon.graphml 
    │   ├── BuildModeWebAndPaperIconTest.class
    │   ├── LoginPage.class
	│	├── LoginPage.graphml
	│   ├── LoginPageTest.class
