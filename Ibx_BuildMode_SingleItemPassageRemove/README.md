# Ibx_BuildMode_SingleItemPassageRemove
Version: 3.0 <br />
...
```jshelllanguage
.
├── Ibx_BuildMode_SingleItemPassageRemove.iml
├── README.md
├── _classpath.xml
├── _project.xml
├── jmeter.log
...
│       │   │   
│       │   └── DataReaders
│		│	│    └── CSVDataReaderBuildSingleItemPassageRemove.java
│       │   │
│       │   │       
│       │   └── Helpers
...
│       │   │    └── Static.java
│       │   │     
│       │   ├── BuildModeSingleItemPassageRemoveTest.java
│       │   ├── LoginPageTest.java
│       │   └── UserSwitchModelTest.java
│       │
│       └── resources
│           ├── BuildModeSingleItemPassageRemove.csv
│           ├── BuildModeSingleItemPassageRemove.graphml
│           ├── LoginPage.graphml
...
└── target
    ...
    │   │     └── Static.class
	│   │
	│   ├── BuildModeSingleItemPassageRemove.class 
    │   ├── BuildModeSingleItemPassageRemove.csv
	│   ├── BuildModeSingleItemPassageRemove.graphml 
    │   ├── BuildModeSingleItemPassageRemoveTest.class
    │   ├── LoginPage.class
	│	├── LoginPage.graphml
	│   ├── LoginPageTest.class
    ...
    ├── generated-sources
    │   └── graphwalker
    │       ├── BuildModeSingleItemPassageRemove
    │       ├── cache.json
	│       ├── LoginPage
    │       └── UserSwitchModel
    │           
