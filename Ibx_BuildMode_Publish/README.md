...
│       │   │   
│       │   └── DataReaders
│		│	│    └── CSVDataReaderBuildModePublish.java
│       │   │
│       │   │       
│       │   └── Helpers
...
│       │   │    └── Static.java
│       │   │     
│       │   ├── BuildModePublishTest.java
│       │   ├── LoginPageTest.java
│       │   └── UserSwitchModelTest.java
│       │
│       └── resources
│           ├── BuildModePublish.csv
│           ├── BuildModePublish.graphml
│           ├── LoginPage.graphml
...
└── target
    ...
    │   │     └── Static.class
	│   │
	│   ├── BuildModePublish.class 
    │   ├── BuildModePublish.csv
	│   ├── BuildModePublish.graphml 
    │   ├── BuildModePublishTest.class
    │   ├── LoginPage.class
	│	├── LoginPage.graphml
	│   ├── LoginPageTest.class
