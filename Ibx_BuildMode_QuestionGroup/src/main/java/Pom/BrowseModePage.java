...
public class BrowseModePage {
    ...
    private String browse_CreateAssessmentButton, browse_Title_In_CreateAssessmentPopup, browse_CreateButton_In_CreateAssessmentPopup;
    private String browse_ItemSection, browse_AddItem_List, browse_First_Item_Content;
    private String browseModeFirstItem, bankFilterFirstCheckbox, filters, savingMessage;
