...
│       │   │   
│       │   └── DataReaders
│		│	│    └── CSVDataReaderBuildModeStandards.java
│       │   │
│       │   │       
│       │   └── Helpers
...
│       │   │    └── Static.java
│       │   │    
│       │   ├── BuildModeStandardsForItemTest.java
│       │   ├── BuildModeStandardsTest.java
│       │   ├── LoginPageTest.java
│       │   └── UserSwitchModelTest.java
│       │
│       └── resources
│           ├── BuildModeStandards.csv
│           ├── BuildModeStandards.graphml
│           ├── BuildModeStandardsForItem.graphml
│           ├── LoginPage.graphml
...
└── target
    ...
    │   │     └── Static.class
	│   │
	│   ├── BuildModeStandards.class 
    │   ├── BuildModeStandards.csv
	│   ├── BuildModeStandards.graphml 
    │   ├── BuildModeStandardsForItem.class
	│   ├── BuildModeStandardsForItem.graphml
	│   ├── BuildModeStandardsForItemTest.class
	│	├── BuildModeStandardsTest.class
    │   ├── LoginPage.class
	│	├── LoginPage.graphml
	│   ├── LoginPageTest.class
