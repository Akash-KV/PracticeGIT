...
│       │   │   
│       │   └── DataReaders
│		│	│    └── CSVDataReaderBuildBackButton.java
│       │   │
│       │   │       
│       │   └── Helpers
...
│       │   │    └── Static.java
│       │   │     
│       │   ├── BuildModeBackButtonTest.java
│       │   ├── LoginPageTest.java
│       │   └── UserSwitchModelTest.java
│       │
│       └── resources
│           ├── BuildModeBackButton.csv
│           ├── BuildModeBackButton.graphml
│           ├── LoginPage.graphml
...
└── target
    ...
    │   │     └── Static.class
	│   │
	│   ├── BuildModeBackButton.class 
    │   ├── BuildModeBackButton.csv
	│   ├── BuildModeBackButton.graphml 
    │   ├── BuildModeBackButtonTest.class
    │   ├── LoginPage.class
	│	├── LoginPage.graphml
	│   ├── LoginPageTest.class
